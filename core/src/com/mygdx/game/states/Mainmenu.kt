...
import com.mygdx.game.entities.MenuItem
...
//        fontGen.dispose()
        ...
        // create menuitems
        menuItems = Array(itemTitles.size) { i ->
            MenuItem(hudCam.viewportWidth / 2f, hudCam.viewportHeight / 2f - 50f * i, itemTitles[i], font)
